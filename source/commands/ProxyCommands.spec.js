...
describe('ProxyCommands', () => {
  describe('list', () => {
    ...
    it('should be read-only', () => {
      const length = ProxyCommands.list.length;
  ...
  describe('createGETDescriptor()', () => {
    ...
    describe('When target is Object', () => {
      ...
      it('should add descriptor to Array', () => {
        expect(target[ProxyCommandFields.get]).to.be.an.instanceof(CommandDescriptor);
      });
    });
  });
...
describe('createDescriptors()', () => {
  ...
  describe('When no target supplied', () => {
    ...
    it('should create properties for descriptors', () => {
      expect(target[ProxyCommandFields.get]).to.be.an.instanceof(CommandDescriptor);
      expect(target[ProxyCommandFields.set]).to.be.an.instanceof(CommandDescriptor);
      expect(target[ProxyCommandFields.apply]).to.be.an.instanceof(CommandDescriptor);
    });

...
describe('PoolRegistry', () => {
  ...
  describe('createPool()', () => {
    ...
    beforeEach(() => {
      listener = sinon.spy();
      registry.addEventListener(PoolRegistry.RESOURCE_POOL_CREATED, listener);
    ...
    it(`should fire "${PoolRegistry.RESOURCE_POOL_CREATED}" event`, () => {
  ...
  describe('When registering pool', () => {
    ...
    beforeEach(() => {
      ...
      registry.addEventListener(PoolRegistry.RESOURCE_POOL_REGISTERED, listener);
    ...
    it(`should fire "${PoolRegistry.RESOURCE_POOL_REGISTERED}" event`, () => {
      expect(listener).to.be.calledOnce;
    });
  ...
  describe('When removing pool', () => {
    ...
    beforeEach(() => {
      listener = sinon.spy();
      pool1 = registry.createPool();
      registry.addEventListener(PoolRegistry.RESOURCE_POOL_REMOVED, listener);
    });
    ...
    describe('When removing pool by instance', () => {
      ...
      it(`should fire "${PoolRegistry.RESOURCE_POOL_REMOVED}" event`, () => {
        expect(listener).to.be.calledOnce;
      });

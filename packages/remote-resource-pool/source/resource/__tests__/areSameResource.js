...
describe('areSameResource()', () => {
  ...
  describe('When not resource provided', () => {
    ...
    it('should result in FALSE', () => {
      ...
      expect(areSameResource(child1, { [RESOURCE_INTERNALS_KEY]: { isResource: () => false } })).to.be.false;
      expect(areSameResource(child1, { [RAW_RESOURCE_DATA_KEY]: { $id: '123', $poolId: '321' } })).to.be.false;
    });
  });
});
